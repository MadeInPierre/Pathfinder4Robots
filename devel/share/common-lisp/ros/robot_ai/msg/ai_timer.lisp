...
(cl:defmethod cl:initialize-instance :after ((m <ai_timer>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ai_timer)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_ai-msg:<ai_timer> is deprecated: use robot_ai-msg:ai_timer instead.")))

(cl:ensure-generic-function 'elapsed_time-val :lambda-list '(m))
(cl:defmethod elapsed_time-val ((m <ai_timer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_ai-msg:elapsed_time-val is deprecated.  Use robot_ai-msg:elapsed_time instead.")
  (elapsed_time m))

(cl:ensure-generic-function 'time_left-val :lambda-list '(m))
(cl:defmethod time_left-val ((m <ai_timer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_ai-msg:time_left-val is deprecated.  Use robot_ai-msg:time_left instead.")
  (time_left m))

(cl:ensure-generic-function 'is_finished-val :lambda-list '(m))
(cl:defmethod is_finished-val ((m <ai_timer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_ai-msg:is_finished-val is deprecated.  Use robot_ai-msg:is_finished instead.")
  (is_finished m))
