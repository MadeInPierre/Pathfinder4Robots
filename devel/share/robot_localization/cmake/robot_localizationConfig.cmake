...
if("TRUE" STREQUAL "TRUE")
  set(robot_localization_SOURCE_PREFIX /home/jack/Programming/Robotics/RobotOS/src/robot_localization)
  set(robot_localization_DEVEL_PREFIX /home/jack/Programming/Robotics/RobotOS/devel)
  ...
  set(robot_localization_INSTALL_PREFIX /home/jack/Programming/Robotics/RobotOS/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'jack <jack@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jack/Programming/Robotics/RobotOS/src/robot_localization/${idir}'.  Ask the maintainer 'jack <jack@todo.todo>' to fix it.")
    endif()
...
set(robot_localization_EXPORTED_TARGETS "")
