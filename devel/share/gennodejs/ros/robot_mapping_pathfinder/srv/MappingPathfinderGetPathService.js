...
class MappingPathfinderGetPathServiceRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MappingPathfinderGetPathServiceRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MappingPathfinderGetPathServiceRequest
    let len;
    let data = new MappingPathfinderGetPathServiceRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MappingPathfinderGetPathServiceRequest(null);
...
class MappingPathfinderGetPathServiceResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.waypoints = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MappingPathfinderGetPathServiceResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MappingPathfinderGetPathServiceResponse
    let len;
    let data = new MappingPathfinderGetPathServiceResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MappingPathfinderGetPathServiceResponse(null);
...
module.exports = {
  Request: MappingPathfinderGetPathServiceRequest,
  Response: MappingPathfinderGetPathServiceResponse,
  md5sum() { return 'faeb4d9752daba214ce90de021e3676d'; },
  datatype() { return 'robot_mapping_pathfinder/MappingPathfinderGetPathService'; }
};
